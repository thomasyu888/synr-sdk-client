#' @docType class
#' @title OrgSagebionetworksRepoModelAsynchCacheableRequestBody
#'
#' @description OrgSagebionetworksRepoModelAsynchCacheableRequestBody Class
#'
...
#' @export
OrgSagebionetworksRepoModelAsynchCacheableRequestBody <- R6::R6Class(
  "OrgSagebionetworksRepoModelAsynchCacheableRequestBody",
  public = list(
    ...
    one_of = list("OrgSagebionetworksRepoModelTableDownloadFromTableRequest", "OrgSagebionetworksRepoModelTableQueryBundleRequest", "OrgSagebionetworksRepoModelTableQueryNextPageToken"),
    #' Initialize a new OrgSagebionetworksRepoModelAsynchCacheableRequestBody.
    #'
    #' @description
    #' Initialize a new OrgSagebionetworksRepoModelAsynchCacheableRequestBody.
    #'
    #' @param instance an instance of the object defined in the oneOf schemas: "OrgSagebionetworksRepoModelTableDownloadFromTableRequest", "OrgSagebionetworksRepoModelTableQueryBundleRequest", "OrgSagebionetworksRepoModelTableQueryNextPageToken"
    #' @export
    initialize = function(instance = NULL) {
      if (is.null(instance)) {
        ...
        stop(paste("Failed to initialize OrgSagebionetworksRepoModelAsynchCacheableRequestBody with oneOf schemas OrgSagebionetworksRepoModelTableDownloadFromTableRequest, OrgSagebionetworksRepoModelTableQueryBundleRequest, OrgSagebionetworksRepoModelTableQueryNextPageToken. Provided class name: ",
                   get(class(instance)[[1]], pos = -1)$classname))
      }
    },
    #' Deserialize JSON string into an instance of OrgSagebionetworksRepoModelAsynchCacheableRequestBody.
    #'
    #' @description
    #' Deserialize JSON string into an instance of OrgSagebionetworksRepoModelAsynchCacheableRequestBody.
    ...
    #' @return An instance of OrgSagebionetworksRepoModelAsynchCacheableRequestBody.
    #' @export
    ...
    fromJSON = function(input) {
      ...
      if (matched == 1) {
        ...
        # more than 1 match
        stop(paste("Multiple matches found when deserializing the input into OrgSagebionetworksRepoModelAsynchCacheableRequestBody with oneOf schemas OrgSagebionetworksRepoModelTableDownloadFromTableRequest, OrgSagebionetworksRepoModelTableQueryBundleRequest, OrgSagebionetworksRepoModelTableQueryNextPageToken. Matched schemas: ",
                   paste(matched_schemas, collapse = ", ")))
      } else {
        # no match
        stop(paste("No match found when deserializing the input into OrgSagebionetworksRepoModelAsynchCacheableRequestBody with oneOf schemas OrgSagebionetworksRepoModelTableDownloadFromTableRequest, OrgSagebionetworksRepoModelTableQueryBundleRequest, OrgSagebionetworksRepoModelTableQueryNextPageToken. Details: >>",
                   paste(error_messages, collapse = " >> ")))
      }

      self
    },
    #' Serialize OrgSagebionetworksRepoModelAsynchCacheableRequestBody to JSON string.
    #'
    #' @description
    #' Serialize OrgSagebionetworksRepoModelAsynchCacheableRequestBody to JSON string.
    #'
    #' @return JSON string representation of the OrgSagebionetworksRepoModelAsynchCacheableRequestBody.
    #' @export
    ...
    #' Serialize OrgSagebionetworksRepoModelAsynchCacheableRequestBody to JSON.
    #'
    #' @description
    #' Serialize OrgSagebionetworksRepoModelAsynchCacheableRequestBody to JSON.
    #'
    #' @return JSON representation of the OrgSagebionetworksRepoModelAsynchCacheableRequestBody.
    #' @export
    toJSON = function() {
      if (!is.null(self$actual_instance)) {
    ...
    #' Validate the input JSON with respect to OrgSagebionetworksRepoModelAsynchCacheableRequestBody.
    #'
    #' @description
    #' Validate the input JSON with respect to OrgSagebionetworksRepoModelAsynchCacheableRequestBody and
...
#OrgSagebionetworksRepoModelAsynchCacheableRequestBody$unlock()
#
## Below is an example to define the print function
#OrgSagebionetworksRepoModelAsynchCacheableRequestBody$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#OrgSagebionetworksRepoModelAsynchCacheableRequestBody$lock()
