...
OrgSagebionetworksRepoModelTableFacetColumnValuesRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #' @export
    initialize = function(`concreteType` = NULL, `columnName` = NULL, `jsonPath` = NULL, `facetValues` = NULL, ...) {
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`facetValues`)) {
        self$`facetValues` <- ApiClient$new()$deserializeObj(this_object$`facetValues`, "array[character]", loadNamespace("synclient"))
      }
      self
    },
    #' To JSON string
