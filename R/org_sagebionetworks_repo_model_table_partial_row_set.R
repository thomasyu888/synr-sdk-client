...
OrgSagebionetworksRepoModelTablePartialRowSet <- R6::R6Class(
  ...
  public = list(
    ...
    #' @export
    initialize = function(`concreteType` = NULL, `tableId` = NULL, `rows` = NULL, ...) {
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`rows`)) {
        self$`rows` <- ApiClient$new()$deserializeObj(this_object$`rows`, "array[OrgSagebionetworksRepoModelTablePartialRow]", loadNamespace("synclient"))
      }
      self
    },
    #' To JSON string
