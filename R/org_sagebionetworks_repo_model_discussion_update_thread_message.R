...
#'
#' @docType class
#' @title OrgSagebionetworksRepoModelDiscussionUpdateThreadMessage
#' @description OrgSagebionetworksRepoModelDiscussionUpdateThreadMessage Class
#' @format An \code{R6Class} generator object
#' @field messageMarkdown  character [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
OrgSagebionetworksRepoModelDiscussionUpdateThreadMessage <- R6::R6Class(
  ...
  public = list(
    ...
    #' To JSON String
    #'
    #' @return OrgSagebionetworksRepoModelDiscussionUpdateThreadMessage in JSON format
    #' @export
    toJSON = function() {
      OrgSagebionetworksRepoModelDiscussionUpdateThreadMessageObject <- list()
      if (!is.null(self$`messageMarkdown`)) {
        OrgSagebionetworksRepoModelDiscussionUpdateThreadMessageObject[["messageMarkdown"]] <-
          self$`messageMarkdown`
      }
      OrgSagebionetworksRepoModelDiscussionUpdateThreadMessageObject
    },
    ...
    #' @return the instance of OrgSagebionetworksRepoModelDiscussionUpdateThreadMessage
    #' @export
    ...
    #' Validate JSON input with respect to OrgSagebionetworksRepoModelDiscussionUpdateThreadMessage
    #'
    #' @description
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of OrgSagebionetworksRepoModelDiscussionUpdateThreadMessage
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# OrgSagebionetworksRepoModelDiscussionUpdateThreadMessage$unlock()
#
## Below is an example to define the print function
# OrgSagebionetworksRepoModelDiscussionUpdateThreadMessage$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# OrgSagebionetworksRepoModelDiscussionUpdateThreadMessage$lock()
