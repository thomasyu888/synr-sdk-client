...
OrgSagebionetworksRepoModelDataaccessRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #' @export
    initialize = function(`id` = NULL, `accessRequirementId` = NULL, `researchProjectId` = NULL, `createdOn` = NULL, `modifiedOn` = NULL, `createdBy` = NULL, `modifiedBy` = NULL, `ducFileHandleId` = NULL, `irbFileHandleId` = NULL, `attachments` = NULL, `accessorChanges` = NULL, `etag` = NULL, `concreteType` = NULL, ...) {
      if (!is.null(`id`)) {
