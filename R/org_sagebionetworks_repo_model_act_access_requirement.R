...
OrgSagebionetworksRepoModelACTAccessRequirement <- R6::R6Class(
  ...
  public = list(
    ...
    #' @export
    initialize = function(`versionNumber` = NULL, `id` = NULL, `description` = NULL, `name` = NULL, `etag` = NULL, `createdOn` = NULL, `modifiedOn` = NULL, `createdBy` = NULL, `modifiedBy` = NULL, `subjectsDefinedByAnnotations` = NULL, `subjectIds` = NULL, `accessType` = NULL, `concreteType` = NULL, `actContactInfo` = NULL, `openJiraIssue` = NULL, ...) {
