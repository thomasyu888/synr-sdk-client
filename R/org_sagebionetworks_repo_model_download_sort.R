...
#'
#' @docType class
#' @title OrgSagebionetworksRepoModelDownloadSort
#' @description OrgSagebionetworksRepoModelDownloadSort Class
...
#' @export
OrgSagebionetworksRepoModelDownloadSort <- R6::R6Class(
  "OrgSagebionetworksRepoModelDownloadSort",
  public = list(
    `field` = NULL,
    `direction` = NULL,
    ...
    #' To JSON String
    #'
    #' @return OrgSagebionetworksRepoModelDownloadSort in JSON format
    #' @export
    toJSON = function() {
      OrgSagebionetworksRepoModelDownloadSortObject <- list()
      if (!is.null(self$`field`)) {
        OrgSagebionetworksRepoModelDownloadSortObject[["field"]] <-
          self$`field`
      }
      if (!is.null(self$`direction`)) {
        OrgSagebionetworksRepoModelDownloadSortObject[["direction"]] <-
          self$`direction`
      }
      OrgSagebionetworksRepoModelDownloadSortObject
    },
    ...
    #' @return the instance of OrgSagebionetworksRepoModelDownloadSort
    #' @export
    ...
    #' Validate JSON input with respect to OrgSagebionetworksRepoModelDownloadSort
    #'
    #' @description
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of OrgSagebionetworksRepoModelDownloadSort
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# OrgSagebionetworksRepoModelDownloadSort$unlock()
#
## Below is an example to define the print function
# OrgSagebionetworksRepoModelDownloadSort$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# OrgSagebionetworksRepoModelDownloadSort$lock()
