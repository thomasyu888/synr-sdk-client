...
OrgSagebionetworksRepoModelProjectExternalGoogleCloudStorageLocationSetting <- R6::R6Class(
  ...
  public = list(
    ...
    #' @export
    initialize = function(`concreteType` = NULL, `storageLocationId` = NULL, `uploadType` = NULL, `banner` = NULL, `description` = NULL, `etag` = NULL, `createdOn` = NULL, `createdBy` = NULL, `bucket` = NULL, `baseKey` = NULL, ...) {
