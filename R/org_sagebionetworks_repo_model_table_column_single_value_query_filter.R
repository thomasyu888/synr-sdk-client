...
#' @field values Values to used with the filter. Multiple values will be joined in an OR relationship. list(character) [optional]
...
OrgSagebionetworksRepoModelTableColumnSingleValueQueryFilter <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param values Values to used with the filter. Multiple values will be joined in an OR relationship.
    #' @param ... Other optional arguments.
    #' @export
    initialize = function(`concreteType` = NULL, `isDefiningCondition` = NULL, `columnName` = NULL, `operator` = NULL, `values` = NULL, ...) {
