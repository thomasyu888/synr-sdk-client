#' @docType class
#' @title OrgSagebionetworksRepoModelTableView
#'
#' @description OrgSagebionetworksRepoModelTableView Class
#'
...
#' @export
OrgSagebionetworksRepoModelTableView <- R6::R6Class(
  "OrgSagebionetworksRepoModelTableView",
  public = list(
    ...
    one_of = list("OrgSagebionetworksRepoModelTableDataset", "OrgSagebionetworksRepoModelTableDatasetCollection", "OrgSagebionetworksRepoModelTableEntityView", "OrgSagebionetworksRepoModelTableSubmissionView"),
    #' Initialize a new OrgSagebionetworksRepoModelTableView.
    #'
    #' @description
    #' Initialize a new OrgSagebionetworksRepoModelTableView.
    #'
    #' @param instance an instance of the object defined in the oneOf schemas: "OrgSagebionetworksRepoModelTableDataset", "OrgSagebionetworksRepoModelTableDatasetCollection", "OrgSagebionetworksRepoModelTableEntityView", "OrgSagebionetworksRepoModelTableSubmissionView"
    #' @export
    initialize = function(instance = NULL) {
      if (is.null(instance)) {
        ...
        stop(paste("Failed to initialize OrgSagebionetworksRepoModelTableView with oneOf schemas OrgSagebionetworksRepoModelTableDataset, OrgSagebionetworksRepoModelTableDatasetCollection, OrgSagebionetworksRepoModelTableEntityView, OrgSagebionetworksRepoModelTableSubmissionView. Provided class name: ",
                   get(class(instance)[[1]], pos = -1)$classname))
      }
    },
    #' Deserialize JSON string into an instance of OrgSagebionetworksRepoModelTableView.
    #'
    #' @description
    #' Deserialize JSON string into an instance of OrgSagebionetworksRepoModelTableView.
    ...
    #' @return An instance of OrgSagebionetworksRepoModelTableView.
    #' @export
    ...
    fromJSON = function(input) {
      ...
      if (matched == 1) {
        ...
        # more than 1 match
        stop(paste("Multiple matches found when deserializing the input into OrgSagebionetworksRepoModelTableView with oneOf schemas OrgSagebionetworksRepoModelTableDataset, OrgSagebionetworksRepoModelTableDatasetCollection, OrgSagebionetworksRepoModelTableEntityView, OrgSagebionetworksRepoModelTableSubmissionView. Matched schemas: ",
                   paste(matched_schemas, collapse = ", ")))
      } else {
        # no match
        stop(paste("No match found when deserializing the input into OrgSagebionetworksRepoModelTableView with oneOf schemas OrgSagebionetworksRepoModelTableDataset, OrgSagebionetworksRepoModelTableDatasetCollection, OrgSagebionetworksRepoModelTableEntityView, OrgSagebionetworksRepoModelTableSubmissionView. Details: >>",
                   paste(error_messages, collapse = " >> ")))
      }

      self
    },
    #' Serialize OrgSagebionetworksRepoModelTableView to JSON string.
    #'
    #' @description
    #' Serialize OrgSagebionetworksRepoModelTableView to JSON string.
    #'
    #' @return JSON string representation of the OrgSagebionetworksRepoModelTableView.
    #' @export
    ...
    #' Serialize OrgSagebionetworksRepoModelTableView to JSON.
    #'
    #' @description
    #' Serialize OrgSagebionetworksRepoModelTableView to JSON.
    #'
    #' @return JSON representation of the OrgSagebionetworksRepoModelTableView.
    #' @export
    toJSON = function() {
      if (!is.null(self$actual_instance)) {
    ...
    #' Validate the input JSON with respect to OrgSagebionetworksRepoModelTableView.
    #'
    #' @description
    #' Validate the input JSON with respect to OrgSagebionetworksRepoModelTableView and
...
#OrgSagebionetworksRepoModelTableView$unlock()
#
## Below is an example to define the print function
#OrgSagebionetworksRepoModelTableView$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#OrgSagebionetworksRepoModelTableView$lock()
