#' @docType class
#' @title OrgSagebionetworksRepoModelVersionableEntity
#'
#' @description OrgSagebionetworksRepoModelVersionableEntity Class
#'
...
#' @export
OrgSagebionetworksRepoModelVersionableEntity <- R6::R6Class(
  "OrgSagebionetworksRepoModelVersionableEntity",
  public = list(
    ...
    one_of = list("OrgSagebionetworksRepoModelFileEntity", "OrgSagebionetworksRepoModelTableDataset", "OrgSagebionetworksRepoModelTableDatasetCollection", "OrgSagebionetworksRepoModelTableEntityView", "OrgSagebionetworksRepoModelTableMaterializedView", "OrgSagebionetworksRepoModelTableSubmissionView", "OrgSagebionetworksRepoModelTableTableEntity", "OrgSagebionetworksRepoModelTableVirtualTable"),
    #' Initialize a new OrgSagebionetworksRepoModelVersionableEntity.
    #'
    #' @description
    #' Initialize a new OrgSagebionetworksRepoModelVersionableEntity.
    #'
    #' @param instance an instance of the object defined in the oneOf schemas: "OrgSagebionetworksRepoModelFileEntity", "OrgSagebionetworksRepoModelTableDataset", "OrgSagebionetworksRepoModelTableDatasetCollection", "OrgSagebionetworksRepoModelTableEntityView", "OrgSagebionetworksRepoModelTableMaterializedView", "OrgSagebionetworksRepoModelTableSubmissionView", "OrgSagebionetworksRepoModelTableTableEntity", "OrgSagebionetworksRepoModelTableVirtualTable"
    #' @export
    initialize = function(instance = NULL) {
      if (is.null(instance)) {
        ...
        stop(paste("Failed to initialize OrgSagebionetworksRepoModelVersionableEntity with oneOf schemas OrgSagebionetworksRepoModelFileEntity, OrgSagebionetworksRepoModelTableDataset, OrgSagebionetworksRepoModelTableDatasetCollection, OrgSagebionetworksRepoModelTableEntityView, OrgSagebionetworksRepoModelTableMaterializedView, OrgSagebionetworksRepoModelTableSubmissionView, OrgSagebionetworksRepoModelTableTableEntity, OrgSagebionetworksRepoModelTableVirtualTable. Provided class name: ",
                   get(class(instance)[[1]], pos = -1)$classname))
      }
    },
    #' Deserialize JSON string into an instance of OrgSagebionetworksRepoModelVersionableEntity.
    #'
    #' @description
    #' Deserialize JSON string into an instance of OrgSagebionetworksRepoModelVersionableEntity.
    ...
    #' @return An instance of OrgSagebionetworksRepoModelVersionableEntity.
    #' @export
    ...
    fromJSON = function(input) {
      ...
      if (matched == 1) {
        ...
        # more than 1 match
        stop(paste("Multiple matches found when deserializing the input into OrgSagebionetworksRepoModelVersionableEntity with oneOf schemas OrgSagebionetworksRepoModelFileEntity, OrgSagebionetworksRepoModelTableDataset, OrgSagebionetworksRepoModelTableDatasetCollection, OrgSagebionetworksRepoModelTableEntityView, OrgSagebionetworksRepoModelTableMaterializedView, OrgSagebionetworksRepoModelTableSubmissionView, OrgSagebionetworksRepoModelTableTableEntity, OrgSagebionetworksRepoModelTableVirtualTable. Matched schemas: ",
    ...
    #' Serialize OrgSagebionetworksRepoModelVersionableEntity to JSON string.
    #'
    #' @description
    #' Serialize OrgSagebionetworksRepoModelVersionableEntity to JSON string.
    #'
    #' @return JSON string representation of the OrgSagebionetworksRepoModelVersionableEntity.
    #' @export
    ...
    #' Serialize OrgSagebionetworksRepoModelVersionableEntity to JSON.
    #'
    #' @description
    #' Serialize OrgSagebionetworksRepoModelVersionableEntity to JSON.
    #'
    #' @return JSON representation of the OrgSagebionetworksRepoModelVersionableEntity.
    #' @export
    toJSON = function() {
      if (!is.null(self$actual_instance)) {
    ...
    #' Validate the input JSON with respect to OrgSagebionetworksRepoModelVersionableEntity.
    #'
    #' @description
    #' Validate the input JSON with respect to OrgSagebionetworksRepoModelVersionableEntity and
...
#OrgSagebionetworksRepoModelVersionableEntity$unlock()
#
## Below is an example to define the print function
#OrgSagebionetworksRepoModelVersionableEntity$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#OrgSagebionetworksRepoModelVersionableEntity$lock()
