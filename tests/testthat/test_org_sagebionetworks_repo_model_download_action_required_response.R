...
context("Test OrgSagebionetworksRepoModelDownloadActionRequiredResponse")

model_instance <- OrgSagebionetworksRepoModelDownloadActionRequiredResponse$new()
...
test_that("page", {
  # tests for the property `page` (array[OrgSagebionetworksRepoModelDownloadActionRequiredCount])
