...
context("Test OrgSagebionetworksRepoModelSelfSignAccessRequirementInterface")

model_instance <- OrgSagebionetworksRepoModelSelfSignAccessRequirementInterface$new()
