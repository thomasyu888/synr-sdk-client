...
context("Test PaginatedResultsOfPassingRecord")

model_instance <- PaginatedResultsOfPassingRecord$new()
...
test_that("results", {
  # tests for the property `results` (array[OrgSagebionetworksRepoModelQuizPassingRecord])
