...
context("Test PaginatedResultsOfEntityHeader")

model_instance <- PaginatedResultsOfEntityHeader$new()
...
test_that("results", {
  # tests for the property `results` (array[OrgSagebionetworksRepoModelEntityHeader])
