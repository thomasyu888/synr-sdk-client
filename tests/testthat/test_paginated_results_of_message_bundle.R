...
context("Test PaginatedResultsOfMessageBundle")

model_instance <- PaginatedResultsOfMessageBundle$new()
...
test_that("results", {
  # tests for the property `results` (array[OrgSagebionetworksRepoModelMessageMessageBundle])
