...
context("Test OrgSagebionetworksRepoModelFileCloudProviderFileHandleInterface")

model_instance <- OrgSagebionetworksRepoModelFileCloudProviderFileHandleInterface$new()
