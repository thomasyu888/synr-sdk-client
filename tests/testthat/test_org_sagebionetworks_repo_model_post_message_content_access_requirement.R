...
context("Test OrgSagebionetworksRepoModelPostMessageContentAccessRequirement")

model_instance <- OrgSagebionetworksRepoModelPostMessageContentAccessRequirement$new()
