...
context("Test PaginatedResultsOfAccessRequirement")

model_instance <- PaginatedResultsOfAccessRequirement$new()
...
test_that("results", {
  # tests for the property `results` (array[OrgSagebionetworksRepoModelAccessRequirement])
