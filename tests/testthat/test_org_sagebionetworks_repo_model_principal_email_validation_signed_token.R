...
context("Test OrgSagebionetworksRepoModelPrincipalEmailValidationSignedToken")

model_instance <- OrgSagebionetworksRepoModelPrincipalEmailValidationSignedToken$new()
