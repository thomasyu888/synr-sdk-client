...
context("Test OrgSagebionetworksRepoModelProjectUploadDestinationListSetting")

model_instance <- OrgSagebionetworksRepoModelProjectUploadDestinationListSetting$new()
