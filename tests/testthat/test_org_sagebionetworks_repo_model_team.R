...
context("Test OrgSagebionetworksRepoModelTeam")

model_instance <- OrgSagebionetworksRepoModelTeam$new()
...
test_that("canRequestMembership", {
  # tests for the property `canRequestMembership` (character)

  # uncomment below to test the property
  #expect_equal(model.instance$`canRequestMembership`, "EXPECTED_RESULT")
})
