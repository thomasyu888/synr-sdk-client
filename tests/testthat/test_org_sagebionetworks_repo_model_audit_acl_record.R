...
context("Test OrgSagebionetworksRepoModelAuditAclRecord")

model_instance <- OrgSagebionetworksRepoModelAuditAclRecord$new()

test_that("ownerType", {
  # tests for the property `ownerType` (character)

  # uncomment below to test the property
  #expect_equal(model.instance$`ownerType`, "EXPECTED_RESULT")
})
