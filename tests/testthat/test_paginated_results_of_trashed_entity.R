...
context("Test PaginatedResultsOfTrashedEntity")

model_instance <- PaginatedResultsOfTrashedEntity$new()
...
test_that("results", {
  # tests for the property `results` (array[OrgSagebionetworksRepoModelTrashedEntity])
