...
context("Test OrgSagebionetworksRepoModelWikiWikiPage")

model_instance <- OrgSagebionetworksRepoModelWikiWikiPage$new()
...
test_that("markdown", {
  # tests for the property `markdown` (character)

  # uncomment below to test the property
  #expect_equal(model.instance$`markdown`, "EXPECTED_RESULT")
})
