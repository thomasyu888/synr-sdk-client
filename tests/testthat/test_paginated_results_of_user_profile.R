...
context("Test PaginatedResultsOfUserProfile")

model_instance <- PaginatedResultsOfUserProfile$new()
...
test_that("results", {
  # tests for the property `results` (array[OrgSagebionetworksRepoModelUserProfile])
