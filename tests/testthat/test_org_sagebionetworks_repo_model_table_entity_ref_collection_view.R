...
context("Test OrgSagebionetworksRepoModelTableEntityRefCollectionView")

model_instance <- OrgSagebionetworksRepoModelTableEntityRefCollectionView$new()
...
test_that("items", {
  ...
  # The flat list of entities referenced by this view.  Limit: 30K items.
