...
context("Test PaginatedResultsOfWikiHeader")

model_instance <- PaginatedResultsOfWikiHeader$new()
...
test_that("results", {
  # tests for the property `results` (array[OrgSagebionetworksRepoModelWikiWikiHeader])
