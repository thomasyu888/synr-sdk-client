...
context("Test PaginatedResultsOfMembershipInvitation")

model_instance <- PaginatedResultsOfMembershipInvitation$new()
...
test_that("results", {
  # tests for the property `results` (array[OrgSagebionetworksRepoModelMembershipInvitation])
