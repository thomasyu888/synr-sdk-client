...
context("Test PaginatedResultsOfTeamMember")

model_instance <- PaginatedResultsOfTeamMember$new()
...
test_that("results", {
  # tests for the property `results` (array[OrgSagebionetworksRepoModelTeamMember])
